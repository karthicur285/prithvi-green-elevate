    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          // fixed positioning allows the menu to span the viewport and keeps it
          // inside the React tree for hover state, even though it's visually
          // detached from the trigger button.
          className="fixed left-0 right-0 top-16 md:top-20 bg-background shadow-xl border-t border-border z-50"
        >
