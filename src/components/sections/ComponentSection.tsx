    ...
    <section className="section-padding bg-secondary">
      <div className="container-custom">
        ...
        <div className="lg:w-[38%] flex flex-col justify-center">
            ...
            <h2 className="font-heading text-3xl md:text-4xl lg:text-[2.8rem] font-bold text-foreground leading-[1.25] tracking-tight space-y-2 mb-6">
            ...
            <p className="font-body text-muted-foreground text-sm md:text-base mb-8 max-w-md leading-relaxed">
                End-to-end manufacturing expertise delivering reliable,
                certified elevator components for every project scale.
            </p>
